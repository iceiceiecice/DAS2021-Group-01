...
```{r barplot of sex by type of household, eval = TRUE, fig.align='center', fig.cap="Barplot of household head'ssex by type of household", out.width='80%', fig.pos = "H"}
...
Hence we can see that the male household head's number of family members tend to be more then the female's.
...
```{r}
mean(data.score$Total.Number.of.Family.members)
```

```{r}
var(data.score$Total.Number.of.Family.members)
```

Since the standard deviation of total number of family members is slightly bigger than the mean of total number of family members, thus, there won't have over-dispesion in our model.
