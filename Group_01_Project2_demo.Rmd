...
p1<- ggplot(data.score, aes(y=Total.Number.of.Family.members)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Total Number of Family Members", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p2<- ggplot(data.score, aes(y=Total.Household.Income)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Total Household Income (10000 Peso)", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p3<- ggplot(data.score, aes(y=Total.Food.Expenditure)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Total Food Expenditure (10000 Peso)", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p4<-ggplot(data.score, aes(y=Household.Head.Age)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Age of Head of Household", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p5<- ggplot(data.score, aes(y=House.Age)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Age of the House", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p6<- ggplot(data.score, aes(y=Number.of.bedrooms)) +
  geom_boxplot(color="royalblue1") +
  labs(x="",y="Number of Bedrooms", title="") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels=NULL)

p7<- ggplot(data = data, aes(x = Type.of.Household)) +
  geom_bar(stat = "count", position = "dodge") +
  labs(x = "Type of Household")
  
p8<- ggplot(data = data, aes(x = Household.Head.Sex)) +
  geom_bar(stat = "count", position = "dodge") +
  labs(x = "Head of Household Sex")

p9<- ggplot(data = data, aes(x = Electricity)) +
  geom_bar(stat = "count", position = "dodge") +
  labs(x = "Electricity in Household")+
  scale_x_discrete(labels=NULL)

grid.arrange(p1, p2, p3, p4, p5, p6, p8, p9, p7, nrow=3)
```
...
knitr::kable(table_household, booktabs = TRUE)
```
...
```{r compare plot, eval = TRUE, fig.align='center', fig.cap="Predicted Numbers of Household Members", out.width='80%', fig.pos = "H"}
