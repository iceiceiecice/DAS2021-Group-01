...
data.score %>%
  cor() %>%
  kable(caption = 'Table 2: Correlation of all variables.',booktabs = TRUE, digits = 3) %>%
  kable_styling(font_size = 10, latex_options = "scale_down")
...
```{r pairs, echo=FALSE, out.width= '100%', fig.cap="Figrue 3: Paired plots of the variables",fig.align = "center"}
