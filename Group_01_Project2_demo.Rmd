...
```{r barplot1 of sex by type of household, eval = TRUE, fig.align='center', fig.cap="Barplot of household head's sex by type of household", out.width='80%', fig.pos = "H"}
...
```
>>>>>>> 73f02510c1fbb3a69ca3d233e9d5d68f2aebc7c4

***
\newpage

# Analysis of Relationships between variables {#sec:ARC}
...
First let's look at the scatterplots  and boxplots of the response variable versus the explanatory variables.
...
p6= ggplot(data = data, aes(x = Household.Head.Sex, y = Total.Number.of.Family.members,fill= Household.Head.Sex)) +
  geom_boxplot() +
  labs(x = "Head of Household Sex", y = "Number of people living in the house")+ 
...
p7=ggplot(data, aes(x = Type.of.Household, y = Total.Number.of.Family.members, fill=Type.of.Household)) +
  geom_boxplot() +
  labs(x = "Type of Household", y = "Number of people living in the house")+ 
  theme(legend.position = "none", axis.title.x = element_text(size = 6), axis.title.y= element_text(size = 7))+
  scale_x_discrete(labels=c("Extend","Single","Two/more"))

p8=ggplot(data = data, aes(x = as.factor(Number.of.bedrooms), y = Total.Number.of.Family.members,fill=Number.of.bedrooms)) +
  geom_boxplot() +
  labs(x = "Number of bedrooms", y = "Number of people living in the house")+ 
  theme(legend.position = "none",axis.title.x = element_text(size = 7), axis.title.y= element_text(size = 7))

p9= ggplot(data = data, aes(x = as.factor(Electricity), y = Total.Number.of.Family.members,fill=Electricity)) +
  geom_boxplot() +
  labs(x = "Electricity", y = "Number of people living in the house")+ 
  theme(legend.position = "none", axis.title.x = element_text(size = 7), axis.title.y= element_text(size = 7))

grid.arrange(p1, p2,p3,p4,p5,p6,p7,p8,p9, ncol = 3)
```
Based on the figure, it can be seen that food expenditure, age of the homeowner, gender of the homeowner and age of the house seem to have a weak effect on the number of people in the household. However, we will analyze the details below by GLM.   
...
The following boxplot in Figure 7 shows the log transformed household income and shows there are still several outliers following the transformation. 
...
The scatterplot in Figure 8 of household income against total food expenditure suggests a positive correlation but the fitted model may be being heavily influenced by the extreme values, particularly by one extreme point.
...
It is important to note that the p-value for family type being more than two people is greater than 0.05, which indicates that family type being more than two people does not have an effect on the response variable, but being single(p value <0.05) does have an effect on the number of people in the household.
...
Combining the p-values and confidence intervals for each variable, we can conclude. Household income, food expenditure, age of the homeowner, sex of the homeowner, age of the house, and type of household(Single Family and Extended Family, absolutely not including Two or More Nonrelated Persons/Members) all have an effect on the number of members in a household. 
