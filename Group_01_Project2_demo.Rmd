...
table_household<- data.cat %>% 
  ...
  adorn_totals("row") %>%
  adorn_pct_formatting(); 
knitr::kable(list(table_sex, table_household), booktabs = TRUE, valign = 'middle', caption = "Summary of Categorial Explanatory Variables")
```
...
```{r confidence interval, eval = TRUE, fig.align='center',out.width='80%', fig.pos = "H"}
